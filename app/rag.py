...
EXPLICIT_DOCUMENT_CODE_MATCH_BOOST = 220.0
EXPLICIT_DOCUMENT_CODE_INTERSECTION_BOOST = 240.0
...
def document_code_boost(question: str, title: str, text: str, source_id: Any = None) -> float:
    ...
    if query_codes and row_codes:
        boost += len(query_codes & row_codes) * EXPLICIT_DOCUMENT_CODE_INTERSECTION_BOOST
    ...
    for code in row_codes:
        ...
        if compact in query or code.lower() in query:
            boost += EXPLICIT_DOCUMENT_CODE_MATCH_BOOST
